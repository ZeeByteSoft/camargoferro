export const services = [
  {
    ...
    description:
      "Entre em contato via WhatsApp ou telefone para agendarmos uma conversa inicial.",
    delay: 0,
  },
  {
    icon: "feather-map",
    ...
    description:
      "Visitamos seu lar para conhecer o espaço e entender suas necessidades específicas.",
    delay: 100,
  },
  {
    icon: "feather-cast",
    ...
    description:
      "Desenvolvimento do projeto 3D detalhado com todas as especificações técnicas.",
    delay: 200,
  },
    {
    ...
    description:
      "Apresentação do projeto final com ajustes e aprovação de todos os detalhes.",
    delay: 100,
  },
    {
    ...
    title: "Produção",
    description:
      "Fabricação dos móveis com materiais selecionados e acabamento impecável.",
    delay: 0,
  ...
  },
  {
    ...
    description:
      "Entrega e instalação profissional em sua residência com garantia total.",
    delay: 100,
